...
<script>
  ...
  const submit = async () => {
    ...
    await fetch(
      "http://localhost:4000/api/manajemen_organisasi/user/" + dataParam.slug,
      {
        method: "PUT",
        headers: {
          Accept: "application/json",
...
<div class="container">
  <form on:submit|preventDefault={submit}>
    ...
    <div class="form-group">
      ...
      <input type="text" id="email" class="form-control" bind:value={email} disabled/>
    </div>
